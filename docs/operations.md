...
`forge-sec-scanner-core` is centered on security tooling work in PHP. The technical target is: Implement a PHP security tooling project for scanner simulation kernel, using seeded input scenarios and deterministic summary checks.
