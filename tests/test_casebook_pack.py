"""Regression checks for the forge-sec-scanner-core casebook."""
...
from casebook.harness import assert_expected, forge_sec_scanner_core_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(forge_sec_scanner_core_summary(), assert_expected())
